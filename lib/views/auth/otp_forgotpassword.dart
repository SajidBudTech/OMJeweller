...
class ForgotOTPPage extends StatefulWidget {
  ForgotOTPPage({Key key, this.user}) : super(key: key);
    ...
    _otpBloc.uiState.listen((uiState) async {
      if (uiState == UiState.redirect) {
        // await Navigator.popUntil(context, (route) => false);
         Navigator.pushNamed(context, AppRoutes.changePasswordRoute,arguments: widget.user);
                    ...
                    SliverPadding(
                        ...
                        sliver: SliverList(
                            delegate: SliverChildListDelegate([
                              ...
                              Text(
                                "We have sent and OTP to your mobile number in order to change your password",
                              ...
                              builder: (context, snapshot) {
                                ...
                                return CustomButton(
                                  ...
                                  onPressed: uiState != UiState.loading
                                      ? () {
                                     if((_otpBloc.firstDigitTEC.text +
                                     _otpBloc.secondDigitTEC.text +
                                     _otpBloc.threeDigitTEC.text +
                                     _otpBloc.fourthDigitTEC.text)==_otpBloc.user.otp.toString()){
                                       Navigator.pushNamed(context, AppRoutes.changePasswordRoute,arguments: widget.user);
                                     }else{
                                       EdgeAlert.show(
                                         context,
