...
class StoreCallContent extends StatefulWidget {
  StoreCallContent({
    Key key,
  ...
  final String vendor;
  @override
  _StoreCallContentState createState() => _StoreCallContentState();
}

class _StoreCallContentState extends State<StoreCallContent> {
              ...
              children: [
                ...
                Container(
                  ...
                  // the faild view
                    ...
                    itemCount: model.storeCallList.length,
                    ...
                    itemBuilder: (context, index) {
                      return StoreLocationListViewItem(
                        notification: model.storeCallList[index],
                        current_index: index,
                        SELECTED_INDEX: SELECTED_POSITION,
                        onPressed: (){
                          setState(() {
                            SELECTED_POSITION=index;
                            AppStrings.selectedTypeDetails=model.storeCallList[index];
                          });
                        },
                      );
                    },
                        ...
                        child: CustomButton(
                          ...
                          onPressed: uiState != UiState.loading
                            ...
                            if(SELECTED_POSITION!=-1) {
                              ...
                              EdgeAlert.show(
                                context,
                                title: "Please select call type!",
                                description: "select one of call option.",
